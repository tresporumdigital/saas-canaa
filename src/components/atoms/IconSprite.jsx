...
// Traço único 1.8px, currentColor. Renderizado uma vez por template (AppLayout, AuthLayout).
  ...
  return (
    <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
      <defs>
        ...
        <symbol id="ic-lock" viewBox="0 0 24 24"><rect x="4.5" y="10.5" width="15" height="10.5" rx="2.4" /><path d="M8 10.5V7.5a4 4 0 0 1 8 0v3" /><circle cx="12" cy="15.5" r="1.4" fill="currentColor" stroke="none" /></symbol>
        <symbol id="ic-eye" viewBox="0 0 24 24"><path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12Z" /><circle cx="12" cy="12" r="3.2" /></symbol>
        <symbol id="ic-eye-off" viewBox="0 0 24 24"><path d="M4 4l16 16" /><path d="M9.6 5.9A9.3 9.3 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17 17 0 0 1-3.3 3.9M6.4 7.5A17 17 0 0 0 2.5 12S6 18.5 12 18.5c1.2 0 2.3-.2 3.3-.6" /><path d="M9.8 9.9a3.2 3.2 0 0 0 4.4 4.5" /></symbol>
        <symbol id="ic-arrow-right" viewBox="0 0 24 24"><line x1="4" y1="12" x2="19" y2="12" /><polyline points="13 6 19 12 13 18" /></symbol>
        <symbol id="ic-sparkle" viewBox="0 0 24 24"><path d="M12 3l2 5 5 2-5 2-2 5-2-5-5-2 5-2 2-5Z" /><path d="M19 14l1 2.5L22.5 18 20 19l-1 2.5L18 19l-2.5-1 2.5-1 1-2.5Z" /></symbol>
      </defs>
    </svg>
  );
}
